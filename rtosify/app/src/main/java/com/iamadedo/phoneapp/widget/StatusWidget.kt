package com.iamadedo.phoneapp.widget
...
import com.iamadedo.phoneapp.MainActivity
import com.iamadedo.phoneapp.R

class StatusWidget : AppWidgetProvider() {

    companion object {
        const val ACTION_WIDGET_UPDATE = "com.iamadedo.phoneapp.widget.ACTION_WIDGET_UPDATE"
        const val ACTION_TOGGLE_DND = "com.iamadedo.phoneapp.widget.ACTION_TOGGLE_DND"
        const val ACTION_TOGGLE_MIRROR = "com.iamadedo.phoneapp.widget.ACTION_TOGGLE_MIRROR"
        const val ACTION_REQUEST_STATUS_UPDATE = "com.iamadedo.phoneapp.widget.ACTION_REQUEST_STATUS_UPDATE"
