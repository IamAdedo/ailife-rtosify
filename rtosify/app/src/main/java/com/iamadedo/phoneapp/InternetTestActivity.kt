...
import com.iamadedo.phoneapp.communication.SignalingClient
...
class InternetTestActivity : AppCompatActivity() {
    ...
    private suspend fun runTests() {
        ...
        val signalingUrl = devicePrefs.getString("internet_signaling_url", "http://signaling.rtosify.ai-life.xyz:8080") ?: ""
