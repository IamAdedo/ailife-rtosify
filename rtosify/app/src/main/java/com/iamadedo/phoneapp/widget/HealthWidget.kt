...
class HealthWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_WIDGET_HEALTH_UPDATE = "com.iamadedo.phoneapp.widget.ACTION_WIDGET_HEALTH_UPDATE"
        const val ACTION_REQUEST_HEALTH_UPDATE = "com.iamadedo.phoneapp.widget.ACTION_REQUEST_HEALTH_UPDATE"
