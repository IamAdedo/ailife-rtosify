...
class NotificationSettingsActivity : AppCompatActivity() {
    ...
    private fun setupBehaviorSwitches() {
        ...
        rowNotifSoundSelector.setOnClickListener {
            ...
            val intent = Intent("com.iamadedo.phoneapp.ACTION_REQUEST_WATCH_RINGTONE_PICKER")
    ...
    private fun sendSettingsUpdate() {
        val intent = android.content.Intent("com.iamadedo.phoneapp.ACTION_UPDATE_SETTINGS")
        intent.setPackage(packageName)
        sendBroadcast(intent)
    }
