...
import com.iamadedo.phoneapp.ble.BleDataGattClient
import com.iamadedo.phoneapp.ble.BleDataGattServer
...
class BleTransport(
    ...
    private suspend fun connectAsClient(): Boolean {
        ...
        val connectInitiated = if (targetDeviceName != null) {
            gattClient?.connectByName(targetDeviceName, com.iamadedo.phoneapp.ble.BleRssiUuids.DATA_TRANSPORT_SERVICE_UUID) ?: false
        } else {
