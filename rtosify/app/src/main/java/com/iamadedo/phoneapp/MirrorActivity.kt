...
class MirrorActivity : AppCompatActivity(), SurfaceHolder.Callback {
    companion object {
        ...
        const val ACTION_SCREEN_DATA = "com.iamadedo.phoneapp.SCREEN_DATA_RECEIVED"
        const val ACTION_MIRROR_RES_CHANGE = "com.iamadedo.phoneapp.MIRROR_RES_CHANGE"
    }
    ...
    private fun sendRemoteNavigation(navAction: Int) {
        val intent = Intent("com.iamadedo.phoneapp.SEND_REMOTE_INPUT")
    ...
    private fun checkResolutionMatching() {
        ...
        if (resMatching || aspectMatching) {
            ...
            val intent = Intent("com.iamadedo.phoneapp.UPDATE_REMOTE_RESOLUTION")
            intent.setPackage(packageName)
    ...
    override fun onDestroy() {
        ...
        val stopIntent = Intent("com.iamadedo.phoneapp.SEND_MIRROR_STOP")
        stopIntent.setPackage(packageName)
        sendBroadcast(stopIntent)

        // Reset resolution if matching was enabled
        if (activePrefs.getBoolean("mirror_res_matching", false)) {
            val resetIntent = Intent("com.iamadedo.phoneapp.UPDATE_REMOTE_RESOLUTION")
