package com.iamadedo.phoneapp.media
...
object VideoCompressor {
    ...
    fun compressVideo(inputPath: String, outputPath: String): Boolean {
        ...
        try {
            ...
            val surface = com.iamadedo.phoneapp.media.OutputSurface(inputSurface) // We need an EGL wrapper to link decoder output to encoder input
