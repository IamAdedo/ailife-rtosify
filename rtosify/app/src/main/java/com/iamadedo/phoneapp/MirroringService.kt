...
class MirroringService : Service() {
    companion object {
        ...
        const val ACTION_MIRROR_STATE_CHANGED = "com.iamadedo.phoneapp.MIRROR_STATE_CHANGED"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val filter = IntentFilter("com.iamadedo.phoneapp.STOP_MIRROR")
        ...
        val refreshFilter = IntentFilter("com.iamadedo.phoneapp.REFRESH_MIRROR")
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                        ...
                        if (outputBuffer != null) {
                            ...
                            if ((bufferInfo.flags and MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                                ...
                                if (callback != null) {
                                    ...
                                    val intent = Intent("com.iamadedo.phoneapp.SCREEN_DATA_AVAILABLE")
    ...
    private val stopReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                "com.iamadedo.phoneapp.STOP_MIRROR" -> {
