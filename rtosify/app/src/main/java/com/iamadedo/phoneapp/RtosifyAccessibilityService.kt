...
class RtosifyAccessibilityService : AccessibilityService() {
    companion object {
        ...
        fun clickNodesWithKeywords(context: Context, keywords: List<String>, toggleOnly: Boolean = false, targetState: Boolean? = null) {
            val intent = Intent("com.iamadedo.phoneapp.CLICK_KEYWORDS").apply {
        ...
        fun performGlobalAction(context: Context, action: Int) {
            val intent = Intent("com.iamadedo.phoneapp.GLOBAL_ACTION").apply {
        ...
        fun performSwipe(context: Context, direction: String) {
            val intent = Intent("com.iamadedo.phoneapp.DISPATCH_SWIPE").apply {
    ...
    override fun onServiceConnected() {
        ...
        val filter = IntentFilter().apply {
            addAction("com.iamadedo.phoneapp.DISPATCH_REMOTE_INPUT")
            addAction("com.iamadedo.phoneapp.CLICK_KEYWORDS")
            addAction("com.iamadedo.phoneapp.GLOBAL_ACTION")
            addAction("com.iamadedo.phoneapp.DISPATCH_SWIPE")
        }
    ...
    private val commandReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            when (intent?.action) {
                "com.iamadedo.phoneapp.DISPATCH_REMOTE_INPUT" -> {
                ...
                "com.iamadedo.phoneapp.CLICK_KEYWORDS" -> {
                ...
                "com.iamadedo.phoneapp.GLOBAL_ACTION" -> {
                    val action = intent.getIntExtra("action", -1)
                    if (action != -1) {
                        performGlobalAction(action)
                    }
                }
                "com.iamadedo.phoneapp.DISPATCH_SWIPE" -> {
