...
import com.ailife.rtosifycompanion.NotificationLogActivity
import com.ailife.rtosifycompanion.R

class NotificationLogWidget : AppWidgetProvider() {

    companion object {
        const val ACTION_NOTIFICATION_LOG_UPDATE = "com.ailife.rtosifycompanion.widget.ACTION_NOTIFICATION_LOG_UPDATE"
    }
