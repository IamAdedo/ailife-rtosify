...
class DndReceiver : BroadcastReceiver() {
    companion object {
        const val ACTION_DND_ON = "com.ailife.rtosifycompanion.ACTION_DND_ON"
        const val ACTION_DND_OFF = "com.ailife.rtosifycompanion.ACTION_DND_OFF"
    ...
    private fun notifyService(context: Context, enabled: Boolean) {
        val serviceIntent = Intent(context, BluetoothService::class.java).apply {
            action = "com.ailife.rtosifycompanion.ACTION_DND_UPDATED"
