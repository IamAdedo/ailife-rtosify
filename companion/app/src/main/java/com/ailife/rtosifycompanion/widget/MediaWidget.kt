...
import com.ailife.rtosifycompanion.MediaControlActivity

class MediaWidget : AppWidgetProvider() {

    companion object {
        const val ACTION_MEDIA_UPDATE = "com.ailife.rtosifycompanion.widget.ACTION_MEDIA_UPDATE"
        
        // Actions to send TO Service/Activity
        const val ACTION_CMD_PLAY_PAUSE = "com.ailife.rtosifycompanion.widget.ACTION_CMD_PLAY_PAUSE"
        const val ACTION_CMD_NEXT = "com.ailife.rtosifycompanion.widget.ACTION_CMD_NEXT"
        const val ACTION_CMD_PREV = "com.ailife.rtosifycompanion.widget.ACTION_CMD_PREV"
        const val ACTION_CMD_VOL_UP = "com.ailife.rtosifycompanion.widget.ACTION_CMD_VOL_UP"
        const val ACTION_CMD_VOL_DOWN = "com.ailife.rtosifycompanion.widget.ACTION_CMD_VOL_DOWN"
