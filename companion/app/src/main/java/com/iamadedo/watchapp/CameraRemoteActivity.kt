...
class CameraRemoteActivity : AppCompatActivity() {
    ...
    companion object {
        const val ACTION_FRAME_RECEIVED = "com.iamadedo.watchapp.ACTION_FRAME_RECEIVED"
        const val ACTION_RECORD_STATUS_CHANGED = "com.iamadedo.watchapp.ACTION_RECORD_STATUS_CHANGED"
