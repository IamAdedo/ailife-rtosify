...
class FindDeviceActivity : AppCompatActivity(), LocationListener {
    ...
    companion object {
        ...
        const val ACTION_LOCATION_UPDATE = "com.iamadedo.watchapp.FIND_DEVICE_LOCATION_UPDATE"
        const val ACTION_STOP_RINGING = "com.iamadedo.watchapp.STOP_RINGING"
        const val ACTION_STOP_FINDING = "com.iamadedo.watchapp.STOP_FINDING"
    }
}
