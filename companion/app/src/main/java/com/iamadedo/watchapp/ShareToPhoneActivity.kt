...
import com.iamadedo.watchapp.ShareData
        ...
        if (intent?.action == Intent.ACTION_SEND) {
            ...
            if (type.startsWith("text/")) {
                ...
                if (text != null) {
                    ...
                    Toast.makeText(this, getString(R.string.toast_text_shared_phone), Toast.LENGTH_SHORT).show()
                    finish()
                } else {
                ...
                if (uri != null) {
                    tvShareStatus.text = getString(R.string.upload_to_phone)
