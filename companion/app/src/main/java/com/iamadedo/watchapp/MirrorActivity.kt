...
class MirrorActivity : AppCompatActivity(), SurfaceHolder.Callback {
    companion object {
        ...
        const val ACTION_SCREEN_DATA = "com.iamadedo.watchapp.SCREEN_DATA_RECEIVED"
        const val ACTION_MIRROR_RES_CHANGE = "com.iamadedo.watchapp.MIRROR_RES_CHANGE"
    }
    ...
    private fun sendRemoteNavigation(navAction: Int) {
        val intent = Intent("com.iamadedo.watchapp.SEND_REMOTE_INPUT")
    ...
    private fun checkResolutionMatching() {
        ...
        if (resMatching || aspectMatching) {
            ...
            val intent = Intent("com.iamadedo.watchapp.UPDATE_REMOTE_RESOLUTION")
            intent.setPackage(packageName)
    ...
    override fun onDestroy() {
        ...
        val stopIntent = Intent("com.iamadedo.watchapp.SEND_MIRROR_STOP")
        ...
        if (prefs.getBoolean("mirror_res_matching", false)) {
            val resetIntent = Intent("com.iamadedo.watchapp.UPDATE_REMOTE_RESOLUTION")
