...
class MirroringService : Service() {
    companion object {
        ...
        const val ACTION_MIRROR_STATE_CHANGED = "com.iamadedo.watchapp.MIRROR_STATE_CHANGED"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        androidx.core.content.ContextCompat.registerReceiver(this, stopReceiver, IntentFilter("com.iamadedo.watchapp.STOP_MIRROR"), androidx.core.content.ContextCompat.RECEIVER_NOT_EXPORTED)
        androidx.core.content.ContextCompat.registerReceiver(this, refreshReceiver, IntentFilter("com.iamadedo.watchapp.REFRESH_MIRROR"), androidx.core.content.ContextCompat.RECEIVER_NOT_EXPORTED)
                        ...
                        if (outputBuffer != null) {
                            ...
                            if ((bufferInfo.flags and MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                                ...
                                if (callback != null) {
                                    ...
                                    val intent = Intent("com.iamadedo.watchapp.SCREEN_DATA_AVAILABLE")
    ...
    private val stopReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            when (intent?.action) {
                "com.iamadedo.watchapp.STOP_MIRROR" -> {
