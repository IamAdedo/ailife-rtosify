...
import com.iamadedo.watchapp.widget.MediaWidget
import com.iamadedo.watchapp.widget.DashboardWidget
...
import com.iamadedo.watchapp.utils.DeviceActionManager
import com.iamadedo.watchapp.servicehelper.BatteryAppUsageHandler
...
class BluetoothService : Service() {
    ...
    // Transport Manager
    private lateinit var transportManager: com.iamadedo.watchapp.communication.TransportManager
    private lateinit var encryptionManager: com.iamadedo.watchapp.security.EncryptionManager
    private var mdnsDiscovery: com.iamadedo.watchapp.communication.MdnsDiscovery? = null
    ...
    interface ServiceCallback {
        ...
        fun onTransportStatusChanged(status: com.iamadedo.watchapp.communication.TransportManager.TransportStatus) {}
    ...
    fun getConnectedDeviceMac(): String? {
        ...
        return if (state is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Connected) {
            state.deviceMac
        } else {
            null
        }
    ...
    companion object {
        ...
        const val ACTION_WATCH_DISMISSED_LOCAL = "com.iamadedo.phoneapp.DISMISSED_LOCAL"
        ...
        const val ACTION_DND_UPDATED = "com.iamadedo.watchapp.ACTION_DND_UPDATED"
        const val ACTION_SCREEN_DATA_RECEIVED = "com.iamadedo.watchapp.SCREEN_DATA_RECEIVED"
        const val ACTION_STOP_MIRROR = "com.iamadedo.watchapp.STOP_MIRROR"
        const val ACTION_SEND_REMOTE_INPUT = "com.iamadedo.watchapp.SEND_REMOTE_INPUT"
        const val ACTION_SCREEN_DATA_AVAILABLE = "com.iamadedo.watchapp.SCREEN_DATA_AVAILABLE"
        const val ACTION_UPDATE_DI_SETTINGS = "com.iamadedo.watchapp.UPDATE_DI_SETTINGS"
        const val ACTION_SHOW_IN_DYNAMIC_ISLAND = "com.iamadedo.watchapp.SHOW_IN_DI"
        const val ACTION_DISMISS_FROM_DYNAMIC_ISLAND = "com.iamadedo.watchapp.DISMISS_FROM_DI"
        const val ACTION_DISMISS_FROM_FULL_SCREEN = "com.iamadedo.watchapp.DISMISS_FROM_FULL_SCREEN"
        const val ACTION_REQUEST_CONNECTION_STATE =
                "com.iamadedo.watchapp.REQUEST_CONNECTION_STATE"
        const val ACTION_CONNECTION_STATE_CHANGED =
                "com.iamadedo.watchapp.CONNECTION_STATE_CHANGED"
        ...
        const val ACTION_LITE_MODE_UPDATE = "com.iamadedo.watchapp.ACTION_LITE_MODE_UPDATE"
        const val ACTION_RESTART_BLE_ADVERTISING = "com.iamadedo.watchapp.ACTION_RESTART_BLE_ADVERTISING"
        const val ACTION_IOS_CONNECTED = "com.iamadedo.watchapp.ACTION_IOS_CONNECTED"
        const val ACTION_FILE_DETECTED = "com.iamadedo.watchapp.ACTION_FILE_DETECTED"
        const val ACTION_FILE_DOWNLOAD_COMPLETE = "com.iamadedo.watchapp.ACTION_FILE_DOWNLOAD_COMPLETE"
        const val ACTION_FILE_DOWNLOAD_PROGRESS = "com.iamadedo.watchapp.ACTION_FILE_DOWNLOAD_PROGRESS"
        const val EXTRA_FILE_PATH = "extra_file_path"
        const val EXTRA_SUCCESS = "extra_success"
        const val EXTRA_PROGRESS = "extra_progress"

        // Audio notification playback actions
        const val ACTION_AUDIO_DOWNLOAD = "com.iamadedo.watchapp.ACTION_AUDIO_DOWNLOAD"
        const val ACTION_AUDIO_PLAY_PAUSE = "com.iamadedo.watchapp.ACTION_AUDIO_PLAY_PAUSE"
        const val ACTION_AUDIO_STOP = "com.iamadedo.watchapp.ACTION_AUDIO_STOP"
        const val EXTRA_NOTIF_ID = "extra_notif_id"
        const val EXTRA_FILE_KEY = "extra_file_key"

        const val ACTION_STOP_RINGTONE = "com.iamadedo.watchapp.ACTION_STOP_RINGTONE"
        const val ACTION_REQUEST_WATCH_RINGTONE_PICKER = "com.iamadedo.watchapp.ACTION_REQUEST_WATCH_RINGTONE_PICKER"
            ...
            object : BroadcastReceiver() {
                override fun onReceive(context: Context?, intent: Intent?) {
                    ...
                    when (intent?.action) {
                        ...
                        "com.iamadedo.watchapp.SEND_MIRROR_STOP" -> {
                        ...
                        "com.iamadedo.watchapp.CALL_ACTION" -> {
                        ...
                        "com.iamadedo.watchapp.ALARM_ACTION" -> {
                            val action = intent.getStringExtra("action")
                            Log.d(TAG, "Handling Dynamic Island alarm action: $action")
                            
                            val alarmIntent = Intent()
                            if (action == "snooze") {
                                alarmIntent.action = "com.iamadedo.watchapp.SNOOZE_ALARM"
                            } else {
                                alarmIntent.action = "com.iamadedo.watchapp.DISMISS_ALARM"
                            }
                            
                            alarmIntent.setPackage(packageName)
                            sendBroadcast(alarmIntent)
                        }
                        "com.iamadedo.watchapp.MEDIA_ACTION" -> {
                            val action = intent.getStringExtra("action")
                        ...
                        "com.iamadedo.watchapp.UPDATE_REMOTE_RESOLUTION" -> {
    ...
    override fun onCreate() {
        ...
        deviceActionManager = com.iamadedo.watchapp.utils.DeviceActionManager(this, userService) {
        ...
        encryptionManager = com.iamadedo.watchapp.security.EncryptionManager(this)
        mdnsDiscovery = com.iamadedo.watchapp.communication.MdnsDiscovery(this)

        transportManager = com.iamadedo.watchapp.communication.TransportManager(
            this,
            serviceScope,
            encryptionManager,
            mdnsDiscovery!!
        ...
        serviceScope.launch {
            transportManager.status.collect { status ->
                ...
                when (state) {
                    is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Connected -> {
                    ...
                    is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Disconnected -> {
                        handleDeviceDisconnected()
                    }
                    is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Waiting -> {
                    ...
                    is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Connecting -> {
        ...
        val filterInternal =
                IntentFilter().apply {
                    ...
                    addAction("com.iamadedo.watchapp.CALL_ACTION")
                    addAction(ACTION_STOP_RINGTONE)
                    addAction("com.iamadedo.watchapp.ALARM_ACTION")
                    addAction("com.iamadedo.watchapp.MEDIA_ACTION")
                }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (intent?.action == "com.iamadedo.watchapp.ACTION_RINGTONE_SELECTED") {
        ...
        if (wasConnected) {
            ...
            if (prefs.getBoolean("notify_on_disconnect", false)) {
                ...
                val disconnectData = NotificationData(
                    packageName = "com.iamadedo.phoneapp",
...
// REMOVED: MessageType.RESPONSE_APPS -> handleResponseApps(message)
    ...
    private fun handlePhoneSettingsUpdate(message: ProtocolMessage) {
        try {
            ...
            val intent = Intent("com.iamadedo.watchapp.ACTION_PHONE_SETTINGS_UPDATE").apply {
                val gson = com.google.gson.Gson()
    ...
    private fun handleMediaStateUpdate(message: ProtocolMessage) {
        try {
            ...
            val widgetIntent = Intent(com.iamadedo.watchapp.widget.MediaWidget.ACTION_MEDIA_UPDATE).apply {
                putExtra(com.iamadedo.watchapp.widget.MediaWidget.EXTRA_TITLE, data.title ?: getString(R.string.media_no_media_short))
                putExtra(com.iamadedo.watchapp.widget.MediaWidget.EXTRA_ARTIST, data.artist ?: "")
                putExtra(com.iamadedo.watchapp.widget.MediaWidget.EXTRA_IS_PLAYING, data.isPlaying)
                setPackage(packageName)
            }
    ...
    private fun handleUpdateSettings(message: ProtocolMessage) {
        try {
            ...
            settings.autoWifiEnabled?.let {
                ...
                val state = transportManager.connectionState.value
                val wifiConnected = state is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Connected && 
    ...
    private fun broadcastStatusUpdate(status: StatusUpdateData) {
        val intent = Intent("com.iamadedo.watchapp.STATUS_UPDATE")
    ...
    private fun handleFindPhoneCommand(message: ProtocolMessage) {
        ...
        if (!enabled) {
            ...
            val intent = Intent("com.iamadedo.watchapp.STOP_RINGING")
            sendBroadcast(intent)
    ...
    private var bleRssiMonitor: com.iamadedo.watchapp.ble.BleRssiMonitor? = null
...
// REMOVED: bluetoothSocket cleanup
        ...
        sendBroadcast(
                Intent("com.iamadedo.watchapp.CONNECTION_STATE_CHANGED").apply {
                    putExtra("connected", false)
                    setPackage(packageName)
                }
        )
    ...
    private fun determineNotificationState(): Triple<Int, String, String> {
        return when {
            isConnected && currentDeviceName != null -> {
                val state = transportManager.connectionState.value
                val statusText = if (state is com.iamadedo.watchapp.communication.TransportManager.ConnectionState.Connected) {
    ...
    private fun handleIncomingCall(message: ProtocolMessage) {
        ...
        if (style != "dynamic_island" || !showCallsInDI) {
            ...
            // Route to Dynamic Island
            sendBroadcast(Intent("com.iamadedo.watchapp.INCOMING_CALL").apply {
                putExtra("number", number)
                putExtra("callerId", callerId)
                setPackage(packageName)
            })
    ...
    private fun handleCallStateChanged(message: ProtocolMessage) {
        ...
        sendBroadcast(Intent("com.iamadedo.watchapp.CALL_STATE_CHANGED").apply {
            putExtra("state", state)
            setPackage(packageName)
        })
    }
    ...
    private fun handleRemoteInput(message: ProtocolMessage) {
        ...
        val intent = Intent("com.iamadedo.watchapp.DISPATCH_REMOTE_INPUT")
        intent.setPackage(packageName) // Make it explicit for Android 14+
        ...
        serviceScope.launch {
            try {
                ...
                if (MirroringService.isRunning) {
                    ...
                    val refreshIntent = Intent("com.iamadedo.watchapp.REFRESH_MIRROR")
    ...
    private fun handleMirrorResChange(message: ProtocolMessage) {
        ...
        val intent = Intent("com.iamadedo.watchapp.MIRROR_RES_CHANGE")
        intent.setPackage(packageName)
