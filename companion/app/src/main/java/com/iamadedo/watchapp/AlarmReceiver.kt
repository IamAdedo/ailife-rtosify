...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_ALARM_TRIGGER = "com.iamadedo.watchapp.ALARM_TRIGGER"
        const val ACTION_DISMISS_ALARM = "com.iamadedo.watchapp.DISMISS_ALARM"
        const val ACTION_SNOOZE_ALARM = "com.iamadedo.watchapp.SNOOZE_ALARM"
    ...
    private fun handleAlarmTrigger(context: Context, intent: Intent) {
        ...
        if (style != "dynamic_island" || !showAlarmsInDI) {
            ...
            val directIntent = Intent("com.iamadedo.watchapp.ALARM_TRIGGERED")
    ...
    private fun handleDismiss(context: Context, intent: Intent) {
        ...
        val clearIntent = Intent("com.iamadedo.watchapp.ALARM_CLEARED")
