...
import com.iamadedo.watchapp.MirrorSettingsActivity
import com.iamadedo.watchapp.CameraRemoteActivity
import com.iamadedo.watchapp.DialerActivity

class DashboardWidget : AppWidgetProvider() {

    companion object {
        const val ACTION_DASHBOARD_UPDATE = "com.iamadedo.watchapp.widget.ACTION_DASHBOARD_UPDATE"
        const val ACTION_REQUEST_DASHBOARD_UPDATE = "com.iamadedo.watchapp.widget.ACTION_REQUEST_DASHBOARD_UPDATE"
        const val ACTION_CMD_CYCLE_RINGER = "com.iamadedo.watchapp.widget.ACTION_CMD_CYCLE_RINGER"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_DASHBOARD_UPDATE) {
            ...
            val serviceIntent = Intent(context, com.iamadedo.watchapp.BluetoothService::class.java).apply {
    ...
    private fun updateAppWidget(
        ...
        val settingsIntent = Intent(context, com.iamadedo.watchapp.PhoneSettingsActivity::class.java)
